...
<div style="display: flex; align-items: flex-start;">
    <img src="assets/images/posts/2023/key-deer-2.jpg" alt="Comparative and Evolutionary Genomics" style="margin-right: 15px; width: 300px;">
<p>
...
<div style="display: flex; align-items: flex-start;">
    <img src="assets/images/posts/2023/panther-statue.jpg" alt="Landscape Genomics of Terrestrial Vertebrates in the Greater Everglades" style="margin-right: 15px; width: 300px;">
<p>
...
<div style="display: flex; align-items: flex-start;">
    <img src="assets/images/pages/bacteria.jpg" alt="The Effect of Urban Environments on Bacterial Diversity in White-tailed Deer" style="margin-right: 15px; width: 300px;">
<p>
...
<div style="display: flex; align-items: flex-start;">
    <img src="assets/images/pages/FLshoreline1.jpg" alt="Living Shoreline Suitability Meta-analysis" style="margin-right: 15px; width: 300px;">
<p>
...
<div style="display: flex; align-items: flex-start;">
    <img src="assets/images/pages/redcat.jpg" alt="Evaluating Microbial Biologics for Lepidopteran Pest Control in Crops" style="margin-right: 15px; width: 300px;">
<p>
...
<div style="display: flex; align-items: flex-start;">
    <img src="assets/images/pages/WPTpond.jpg" alt="Terrestrial Habitat Use by Western Pond Turtles" style="margin-right: 15px; width: 300px;">
<p>
